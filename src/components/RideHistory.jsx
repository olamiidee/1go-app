...
const RideHistory = ({ item }) => {
  ...
  return (
    <>
      ...
      <div
        onClick={link}
        className="w-full px-3 py-2 mb-4 bg-blue-400/10 border-2 border-blue-400/20 text-[0.75rem] md:text-[1rem] rounded-md flex md:hidden flex-wrap md:flex-nowrap items-center transition-all duration-300 scale"
      >
        {/* <div className="mr-2">
          <img
            alt=""
