const AdminBookingTimeBtn = ({ item }) => {
  return (
    <div className="px-3 py-1 bg-blue-300 rounded-md relative flex items-center">
      <div className="absolute top-[-10px] right-[-10px] w-6 h-6 rounded-full flex items-center justify-center bg-white border hover:border-blue-600 border-blue-400 hover:bg-blue-300 cursor-pointer">
